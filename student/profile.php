  ...
  <!--/fixed left area-->
    <div class="right-area" style="position: relative; left: 21%; width: 80%; height: 84vh; ">
        ...
        <div class="profilearea">
          ...
          include "../php/db.php";
          $id = $_SESSION['id'];
          $sql = "SELECT name FROM studentstable  WHERE studid = '$id' ";
          $result = $conn->query($sql);
          //echo $result;
          while ($row = $result->fetch_assoc()){
        ...
        ?>
                    ...
                    <li class="userli"><span>Date of Birth</span><span class="writetvalue" style="background-color: rgb(196, 8, 102);" >
                    <?php echo $row['dateofbirth'];?>
                  </span></li>
                <li class="userli"><span>Faculty</span><span class="writetvalue"style="background-color: yellow ;">
                <?php if($row['facultyid'] == "S13" ){ 
                echo "Science";
              } else{
                echo "Agriculture";
              }
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="message-subject">
              ...
              <input type="password" id="password1" name="subject" value = "password" class="form-control">
            </div>
            <div class="message-subject">
              <label>Cornfirm New Password:</label>
              <input type="password" id="password2" name="subject" value = "password" class="form-control">
            </div>
