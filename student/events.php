...
<div class="whole-area">
   ...
   <div class="fixedleftarea">
    ...
    <ul class="navigation " >
        ...
        <li class="navigation-item"><a href="chats.php" class="navigation-link" >Chats &nbsp; &nbsp;
          <span class="navigation-number" style="background-color: rgb(226, 103, 21);" id="delivered"> 0</span></a></li>

        <li class="navigation-item active"><a href="events.php"class="navigation-link" >Events&nbsp; &nbsp;</a></li>
...
<!-- newevent-->
<div class="modal fade" id="newnotification" data-bs-backdrop="static" data-keyboard=
"false" tabindex="-1" aria-labelledby="placebid" aria-hidden="true">
