...
<li class="navigation-item active"><a href="notifications.php"class="navigation-link" >Notification Management&nbsp; </a></li>
  ...
  <div class="right-area" style="position: relative; left: 21%; width: 80%; height: 84vh; ">
    <div class="right-navigation">
        ...
        <table class="table" >
            ...
            ?>
            <tr>
            <td><a href="#" id ="managenot" data-toggle="modal" data-target="#deletenot" ><?php echo $rows['id'];?></a></td>
    ...
    <div class="modal-content">
      ...
      <div class="message-subject">
             ...
             <option value="all">all</option>
              ...
              <option value="guidance">Medics</option>
             </select>
            </div> 
...
<!--/newnotification-->
<!-- dltnot-->
<div class="modal fade" id="deletenot" data-bs-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="placebid" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg bg-info">
        <h6 class="modal-title" id="sendmessage">Delete Notification</h6>
      </div>
      <div class="modal-body">
      <div class="message-subject">
              <label>Delete Notification ?</label>
      ...
      <div class="modal-footer">
        ...
        <button  type="button" id="closenot" data-dismiss="modal" style="display: none;" ></button>
        <button type="button" id="dltnotbutton"  class="btn btn-danger">DELETE</button>
      </div>
    </div>
  </div>
</div>
...
const manageevent = document.querySelectorAll("#managenot");
...
const dltbutton = document.getElementById("dltnotbutton");
const closedlt = document.getElementById("closenot");
dltbutton.addEventListener("click", ()=>{


let xhr = new XMLHttpRequest();
xhr.open("POST", "../php/deletenot.php", true);
xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
