...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-growl/1.0.0/jquery.bootstrap-growl.min.js" integrity=
    "sha512-pBoUgBw+mK85IYWlMTSeBQ0Djx3u23anXFNQfBiIm2D8MbVT9lr+IxUccP8AMMQ6LCvgnlhUCK3ZCThaBCr8Ng==
   ...
   <div class="fixedleftarea">
    <div class="writers-details">
      ...
      <ul class="navigation " >
          ...
          <li class="navigation-item"><a href="chats.php" class="navigation-link" >Chats &nbsp; &nbsp;<span class=
          "navigation-number" style="background-color: rgb(226, 103, 21);" id="delivered"> 0</span></a></li>
  
  
          <li class="navigation-item"><a href="events.php"class="navigation-link" >Events&nbsp; &nbsp;</a></li>
  
          <li class="navigation-item"><a href="notifications.php"class=
          "navigation-link" >Notifications&nbsp; &nbsp;</a></li>
  
          <li class="navigation-item active"><a href="profile.php" style="display: block;" class=
          "navigation-link"><i class="icon-user"></i> <span>Profile</span></a></li>
  
          <li class="navigation-item"><a href="help.php" style="display: block;" class="navigation-link"><i class=
          "icon-newspaper"></i> <span>Help</span></a></li>
  ...
  <!--/fixed left area-->
    <div class="right-area" style="position: relative; left: 21%; width: 80%; height: 84vh; ">
        ...
        ?>
          ...
          include "../php/db.php";
          $id = $_SESSION['id'];
          $sql = "SELECT email FROM studentstable  WHERE studid = '$id' ";
          $result = $conn->query($sql);
          //echo $result;
          while ($row = $result->fetch_assoc()){
            foreach($row as $value){
        ...
        <div class="writersummary">
            ...
            <ul class="userlist">
                <li class="userli">
                    ...
                    <li class="userli"><span>Gender</span><span class="writetvalue" style=
        ...
        ?>
                    ...
                    <li class="userli"><span>Phone Number</span><span class="writetvalue" style=
                    "background-color: rgb(144, 192, 10);" >
                    <?php echo $row['phone']; ?>
                  </span></li>
                    <li class="userli"><span>Date of Birth</span><span class="writetvalue" style=
                    "background-color: rgb(196, 8, 102);" >
                    <?php echo $row['dateofbirth'];?>
                  </span></li>
                <li class="userli"><span>Role</span><span class="writetvalue"style="background-color: yellow ;">
                <?php echo $row['s_role']; ?>
              </span></li>
...
<button id="passwordbutton"class="summaryheading bg bg-info" data-toggle="modal" data-target=
...
<!--id input-->
  ...
  <!-- edit profile -->
 <div class="modal fade" id="editprofile" data-bs-backdrop="static" data-keyboard="false" tabindex=
 "-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick="editprofilegrowl()" type="button" id=
        "closechanges" data-dismiss="modal" style="display: none;" ></button>
...
<!--/editprofile-->
<!-- Change password-->
<div class="modal fade" id="changepassword" data-bs-backdrop="static" data-keyboard="false" tabindex=
"-1" aria-labelledby="placebid" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="message-subject">
              ...
              <input type="password" id="password1" name="subject"  class="form-control">
            </div>
            <div class="message-subject">
              <label>Cornfirm New Password:</label>
              <input type="password" id="password2" name="subject"  class="form-control">
            </div>
...
function passwordgrowl(){
  $.bootstrapGrowl("Passsword Changed Succesfully", // Messages
{ // options
